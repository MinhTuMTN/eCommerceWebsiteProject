...
<%@ include file="/common/taglib.jsp" %>
 <style>
          ...
          <div class="item-number-1-image">
            ...
            />
				...
				<c:if test="${!fn:startsWith(store.avatar, 'http')}">
					...
					<td><img id="avatar-img"
              alt=""
              width="100%"
              height="100%"
              style="border-radius: 50%"
              onclick="document.getElementById('avatar').click()" src="${urlImage }"></td>
				</c:if>
    ...
    function changeImage() {
        document.getElementById("avatar-img").src = document.getElementById("avatar").value;
    }
    </script>