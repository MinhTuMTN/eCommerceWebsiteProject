...
GO
INSERT [dbo].[Account] ([userId], [address], [avatar], [createdAt], [e_wallet], [email], [firstName], [hashed_password], [id_card], [isActived], [isEmailActive], [isPhoneActive], [lastName], [password], [phone], [point], [role], [salt], [slug], [updatedAt], [userLevelId]) VALUES (2, N'HCM', NULL, CAST(N'2022-12-09T23:38:36.0643487' AS DateTime2), 0, N'admin@email.com', N'Nguyễn', N'', N'', 1, NULL, NULL, N'Bảo', N'123', N'0987654321', 0, 0, N'', N'', CAST(N'2022-12-09T23:38:36.0643487' AS DateTime2), NULL)
GO
...
GO
INSERT [dbo].[UserOrder] ([orderId], [address], [amountFromStore], [amountFromUser], [amountToGD], [amountToStore], [createdAt], [isPaidBefore], [phone], [status], [updatedAt], [deliveryId], [store_storeId], [user_userId]) VALUES (8, N'HCM', 20, 100, 20, 80, CAST(N'2022-12-09T23:38:36.0803062' AS DateTime2), 1, N'0987654321', 2, CAST(N'2022-12-09T23:38:36.0803062' AS DateTime2), NULL, NULL, 7)
GO
INSERT [dbo].[UserOrder] ([orderId], [address], [amountFromStore], [amountFromUser], [amountToGD], [amountToStore], [createdAt], [isPaidBefore], [phone], [status], [updatedAt], [deliveryId], [store_storeId], [user_userId]) VALUES (9, N'HCM', 20, 100, 20, 80, CAST(N'2022-12-09T23:38:36.0803062' AS DateTime2), 1, N'0987654321', 3, CAST(N'2022-12-09T23:38:36.0803062' AS DateTime2), NULL, NULL, 8)
GO
